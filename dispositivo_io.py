...
class DispositivoIO:
    ...
    def instrucao_IO(self, process_id, interrupt_handler: Callable[[TipoInterrupt, str, int, list[w.Word] | None]]):
    ...
    def log_response(self, process_id, interrupt_handler: Callable[[TipoInterrupt, str, int, list[w.Word] | None]]):
